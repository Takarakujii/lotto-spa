    ...
    return (
        <div className="relative min-h-screen overflow-hidden" style={{
            ...
            <header className="relative z-10 p-5 flex justify-between items-center">
                ...
                <div className="text-3xl cursor-pointer" style={{
                    color: "#00ffff",
            ...
            {/* Main content */}
            <main className="container mx-auto px-4 py-8 relative z-10 flex flex-col md:flex-row justify-between gap-8">
                {/* Left column - Account Profile */}
                <div className="flex-1 p-6 rounded-lg" style={{
                ...
                <div className="flex-1 flex flex-col gap-8">
                    <div className="p-6 rounded-lg" style={{
                        ...
                        <div className="p-4 rounded-md mb-2" style={{
                            background: "rgba(30, 30, 50, 0.7)",
                            border: "1px solid rgba(0, 255, 255, 0.5)",
                        }}>
                            <p className="text-lg mb-2" style={{ color: "#00ffff", textShadow: "0 0 3px #00ffff" }}>
                                Account Balance
                            </p>
                    ...
                    <div className="p-6 rounded-lg" style={{
                        ...
                        <div className="p-4 rounded-md flex justify-between items-center mb-6" style={{
                            background: "rgba(30, 30, 50, 0.7)",
                            border: "1px solid rgba(0, 255, 255, 0.5)",
                        }}>
                            <p className="text-4xl font-bold" style={{ color: "#ffffff", textShadow: "0 0 5px #ffffff" }}>
                        ...
                        <div className="flex justify-center gap-8 mb-8">
                            <button
                                ...
                                style={{
                                    ...
                                    boxShadow: isHovered.minus ? "0 0 15px #ff0000, 0 0 25px #ff0000" : "0 0 8px #ff0000",
                                    color: "#ff0000",
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    boxShadow: isHovered.plus ? "0 0 15px #00ff00, 0 0 25px #00ff00" : "0 0 8px #00ff00",
                                    color: "#00ff00",
                        ...
                        <div className="flex justify-center gap-4">
                            <button
                                ...
                                style={{
                                    ...
                                    boxShadow: isHovered.placeBet ? "0 0 15px #00ffff, 0 0 25px #00ffff" : "0 0 8px #00ffff",
                                    color: "#00ffff",
                                    textShadow: "0 0 5px #00ffff",
                                }}
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    boxShadow: isHovered.cancel ? "0 0 15px #cccccc, 0 0 25px #cccccc" : "0 0 8px #cccccc",
                                    color: "#cccccc",
