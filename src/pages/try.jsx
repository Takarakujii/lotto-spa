            ...
            <div className="absolute inset-0"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="space-y-8">
                        {/* Draw Ticket Section */}
                        <div>
                            <h2 className="text-yellow-400 text-3xl mb-4 font-light">DRAW TICKET</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="p-4 rounded-lg border-2 border-fuchsia-900 bg-gray-800 bg-opacity-30 backdrop-blur-sm flex flex-col justify-between h-64"
                                ...
                                {['History', 'Logout', 'Top Up'].map((text, index) => (
                                    <button
                                        key={index}
                                        className={`py-3 px-4 bg-transparent border rounded-md font-mono tracking-wide hover:bg-opacity-20 transition-all transform hover:scale-105 flex justify-between items-center ${text === 'History'
                                        ...
                                        style={{
                                            textShadow: `0 0 5px ${text === 'History'
                                                ? 'rgba(250, 204, 21, 0.5)'
                                                : text === 'Logout'
